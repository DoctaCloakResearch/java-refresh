...
import com.doctacloak.service.WelcomeService;
...
public class WelcomeServletNew extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<String> welcomeMessage = welcomeService.getWelcomeMessage("Christopher");
		...
		// 3. Forward request dispatcher to the view.
